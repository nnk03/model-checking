...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{Light1 \.{=}} Red
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{Light2 \.{=}} Green
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{2 \.{:}\@s{22.5}flip} \ensuremath{color} \ensuremath{of}
 \ensuremath{Light} \ensuremath{i
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{3 \.{:}\@s{22.5}Set} \ensuremath{Counter} \ensuremath{to}
 \ensuremath{20
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{5 \.{:}\@s{12.5}else \{
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{6 \.{:}\@s{22.5}decrement} \ensuremath{counter
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{7 \.{:}\@s{12.5}\}
...
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{Check} \ensuremath{if} \ensuremath{light} \ensuremath{1}
 \ensuremath{has} \ensuremath{color} \ensuremath{green} \ensuremath{and}
 \ensuremath{light} \ensuremath{2} \ensuremath{has} \ensuremath{color}
 \ensuremath{green} \ensuremath{can} \ensuremath{ever} \ensuremath{occur}
 \ensuremath{in} \ensuremath{the} \ensuremath{synchronous
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{composition} \ensuremath{of} \ensuremath{these}
 \ensuremath{systems
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{In} \ensuremath{your} \ensuremath{model} \ensuremath{assume}
 \ensuremath{that} \ensuremath{if} \ensuremath{there} \ensuremath{is}
 \ensuremath{a} \ensuremath{slog (stutter),\, both} \ensuremath{lights}
 \ensuremath{stutter} \ensuremath{together
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{(By} \ensuremath{default,\, such} \ensuremath{a}
 \ensuremath{transition} \ensuremath{is} \ensuremath{assumed} \ensuremath{in}
 \ensuremath{TLA\.{+})
}%
\end{cpar}%
\end{lcom}%
\@x{ {\EXTENDS} Integers}%
\@x{ {\VARIABLES} l1 ,\, l2 ,\, counter}%
\@pvspace{8.0pt}%
\@x{ TypeOK \.{\defeq}}%
\@x{ \.{\land} l1 \.{\in} \{\@w{red} ,\,\@w{green} \}}%
\@x{ \.{\land} l2 \.{\in} \{\@w{red} ,\,\@w{green} \}}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Feb} 06 18:27:42 \ensuremath{IST} 2024 by \ensuremath{neeraj
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
