...
\@x{}\moduleLeftDash\@xx{ {\MODULE} petersons\_algo}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\EXTENDS} Integers}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} pc0 ,\, pc1 ,\, turn ,\, intr0 ,\, intr1}%
\@pvspace{8.0pt}%
\@x{ TypeOK \.{\defeq}}%
\@x{ \.{\land} pc0 \.{\in} 0 \.{\dotdot} 7}%
\@x{ \.{\land} pc1 \.{\in} 0 \.{\dotdot} 7}%
\@x{ \.{\land} turn \.{\in} \{ 0 ,\, 1 \}}%
\@x{ \.{\land} intr0 \.{\in} \{ {\TRUE} ,\, {\FALSE} \}}%
\@x{ \.{\land} intr1 \.{\in} \{ {\TRUE} ,\, {\FALSE} \}}%
\@pvspace{16.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Model \ensuremath{Peterson}\mbox{'}s Algorithm for 2 processes and check
...
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
0 : \ensuremath{while(True)\{
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{1 \.{:}\@s{12.5}\.{\slsl} non} \ensuremath{critical}
 \ensuremath{section
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{2 \.{:}\@s{12.5}intr[i] \.{=} True
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{3 \.{:}\@s{12.5}turn \.{=} 1 \.{-} i
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{4 \.{:}\@s{12.5}while(turn \.{\defeq} 1} \ensuremath{and}
 \ensuremath{intr[1 \.{-} i] \.{\defeq} 1) \.{\slsl} wait
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{5 \.{:}\@s{12.5}\.{\slsl} critical} \ensuremath{section
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{6 \.{:}\@s{12.5}intr[i] \.{=} 0
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{7 \.{:} \}
...
\@x{ \.{\land} pc1 \.{=} 0}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq} Init0 \.{\land} Init1}%
\@pvspace{8.0pt}%
\@x{ L01 \.{\defeq}}%
\@x{ \.{\land} pc0 \.{=} 0}%
\@x{ \.{\land} pc0 \.{'} \.{=} 1}%
\@x{ \.{\land} {\UNCHANGED} {\langle} turn ,\, intr0 ,\, intr1 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ L12 \.{\defeq}}%
\@x{ \.{\land} pc0 \.{=} 1}%
\@x{ \.{\land} pc0 \.{'} \.{=} 2}%
...
\@x{ \.{\land} pc0 \.{'} \.{=} 3}%
\@x{ \.{\land} intr0 \.{'} \.{=} {\TRUE}}%
\@x{ \.{\land} {\UNCHANGED} {\langle} intr1 ,\, turn {\rangle}}%
\@pvspace{8.0pt}%
\@x{ L34 \.{\defeq}}%
\@x{ \.{\land} pc0 \.{=} 3}%
\@x{ \.{\land} pc0 \.{'} \.{=} 4}%
\@x{ \.{\land} turn \.{'} \.{=} 1}%
\@x{ \.{\land} {\UNCHANGED} {\langle} intr0 ,\, intr1 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ L44 \.{\defeq}}%
\@x{ \.{\land} pc0 \.{=} 4}%
\@x{ \.{\land} pc0 \.{'}\@s{1.72} \.{=} 4}%
...
\@x{}%
\@y{%
 \ensuremath{\.{\land} turn\.{'} \.{=} 1
}}%
\@xx{}%
\@x{ \.{\land} intr1 \.{=} {\TRUE}}%
\@x{}%
\@y{%
 \ensuremath{\.{\land} intr1\.{'} \.{=} {\TRUE}
}}%
\@xx{}%
\@x{ \.{\land} {\UNCHANGED} intr0}%
\@pvspace{8.0pt}%
\@x{ L45 \.{\defeq}}%
\@x{ \.{\land} pc0 \.{=} 4}%
\@x{ \.{\land} pc0 \.{'} \.{=} 5}%
\@x{ \.{\land} ( turn \.{=} 0 \.{\lor} intr1 \.{=} {\FALSE} )}%
\@x{ \.{\land} {\UNCHANGED} {\langle} turn ,\, intr0 ,\, intr1 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ L56 \.{\defeq}}%
\@x{ \.{\land} pc0 \.{=} 5}%
\@x{ \.{\land} pc0 \.{'} \.{=} 6}%
\@x{ \.{\land} {\UNCHANGED} {\langle} intr0 ,\, intr1 ,\, turn {\rangle}}%
\@pvspace{8.0pt}%
\@x{ L67 \.{\defeq}}%
\@x{ \.{\land} pc0 \.{=} 6}%
\@x{ \.{\land} pc0 \.{'} \.{=} 7}%
...
\@x{ \.{\land} {\UNCHANGED} {\langle} turn ,\, intr0 ,\, intr1 {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ SLOGP \.{\defeq} {\UNCHANGED} {\langle} pc0 ,\, intr0 ,\, intr1 ,\, turn
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@x{ \.{\land} pc1 \.{'} \.{=} 3}%
\@x{ \.{\land} intr1 \.{'} \.{=} {\TRUE}}%
\@x{ \.{\land} {\UNCHANGED} {\langle} intr0 ,\, turn {\rangle}}%
\@pvspace{8.0pt}%
\@x{ M34 \.{\defeq}}%
\@x{ \.{\land} pc1 \.{=} 3}%
\@x{ \.{\land} pc1 \.{'} \.{=} 4}%
...
\@x{}%
\@y{%
 \ensuremath{\.{\land} turn\.{'} \.{=} 0
}}%
\@xx{}%
\@x{ \.{\land} intr0 \.{=} {\TRUE}}%
\@x{}%
\@y{%
 \ensuremath{\.{\land} intr0\.{'} \.{=} {\TRUE}
}}%
\@xx{}%
\@x{ \.{\land} {\UNCHANGED} intr1}%
\@pvspace{8.0pt}%
\@x{ M45 \.{\defeq}}%
\@x{ \.{\land} pc1 \.{=} 4}%
\@x{ \.{\land} pc1 \.{'} \.{=} 5}%
\@x{ \.{\land} ( turn \.{=} 1 \.{\lor} intr0 \.{=} {\FALSE} )}%
\@x{ \.{\land} {\UNCHANGED} {\langle} turn ,\, intr0 ,\, intr1 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ M56 \.{\defeq}}%
\@x{ \.{\land} pc1 \.{=} 5}%
...
\@x{ \.{\land} {\UNCHANGED} {\langle} turn ,\, intr0 ,\, intr1 {\rangle}}%
\@pvspace{16.0pt}%
 \@x{ SLOGQ \.{\defeq} {\UNCHANGED} {\langle} pc1 ,\, intr0 ,\, intr1 ,\, turn
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Next\_First \.{\defeq}}%
\@x{ \.{\lor} L01}%
...
\@x{ \.{\lor} SLOGQ}%
\@pvspace{8.0pt}%
 \@x{ Next \.{\defeq} ( Next\_First \.{\land} {\UNCHANGED} pc1 ) \.{\lor} (
 Next\_Second \.{\land} {\UNCHANGED} pc0 )}%
\@pvspace{8.0pt}%
 \@x{ Mutual\_Exclusion \.{\defeq} ( pc0 \.{\neq} 5 ) \.{\lor} ( pc1 \.{\neq}
 5 )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@x{}%
\@y{\@s{0}%
 we cannot write \ensuremath{pc0 \.{\neq} 4}, because that\mbox{'}s not a
 requirement, it should be proven
}%
\@xx{}%
 \@x{ J04 \.{\defeq}\@s{4.1} {\lnot} ( ( pc0 \.{=} 4 ) \.{\land} ( ( turn
 \.{=} 0 ) \.{\lor} ( intr1 \.{=} {\FALSE} ) ) )}%
\@x{ J05 \.{\defeq} pc0 \.{\neq} 5}%
\@x{ J06 \.{\defeq} pc0 \.{\neq} 6}%
\@x{ J07 \.{\defeq} pc0 \.{\neq} 7}%
...
\@x{ J13 \.{\defeq} pc1 \.{\neq} 3}%
\@pvspace{8.0pt}%
 \@x{ J14 \.{\defeq}\@s{4.1} {\lnot} ( ( pc1 \.{=} 4 ) \.{\land} ( ( turn
 \.{=} 0 ) \.{\lor} ( intr0 \.{=} {\FALSE} ) ) )}%
\@x{ J15 \.{\defeq} pc1 \.{\neq} 5}%
\@x{ J16 \.{\defeq} pc1 \.{\neq} 6}%
\@x{ J17 \.{\defeq} pc1 \.{\neq} 7}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Feb} 06 18:10:30 \ensuremath{IST} 2024 by \ensuremath{neeraj
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Fri}
 \ensuremath{Feb} 02 11:35:23 \ensuremath{IST} 2024 by
 \ensuremath{neerajkrishnan
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Jan} 30
 17:52:27 \ensuremath{IST} 2024 by \ensuremath{neerajkrishnan
}%
\end{cpar}%
\end{lcom}%
\end{document}
