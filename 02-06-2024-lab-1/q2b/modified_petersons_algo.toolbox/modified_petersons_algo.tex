...
\setboolean{shading}{true}
 ...
 modified\_petersons\_algo}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\EXTENDS} Integers}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Change the algo so that in \ensuremath{P0}, Replace \ensuremath{turn \.{=} 1}
 by \ensuremath{turn \.{=} 0
 } and in \ensuremath{P1}, replace \ensuremath{turn \.{=} 0} by
 \ensuremath{turn \.{=} 1
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{3 \.{:}\@s{12.5}turn \.{=} i \.{\slsl} MODIFIED
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Feb} 06 18:50:18 \ensuremath{IST} 2024 by \ensuremath{neeraj
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Feb} 06
 17:27:29 \ensuremath{IST} 2024 by \ensuremath{neeraj
}%
\end{cpar}%
\end{lcom}%
\end{document}
