...
\@x{}\moduleLeftDash\@xx{ {\MODULE} first}\moduleRightDash\@xx{}%
\@pvspace{16.0pt}%
\@x{ {\EXTENDS} Integers}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} i ,\, pc}%
...
\@x{ Add1 \.{\defeq}}%
\@x{\@s{16.4} \.{\lor}\@s{4.1} \.{\land} pc \.{=}\@w{middle}}%
\@x{\@s{31.61} \.{\land} i \.{'}\@s{2.87} \.{=} i \.{+} 1}%
\@x{\@s{31.61} \.{\land} pc \.{'} \.{=}\@w{done}}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} Pick \.{\lor} Add1}%
\@pvspace{24.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 30 14:30:51 \ensuremath{IST} 2024 by
 \ensuremath{neerajkrishnan
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Jan} 30
 00:36:08 \ensuremath{IST} 2024 by \ensuremath{neerajkrishnan
}%
\end{cpar}%
\end{lcom}%
\end{document}
