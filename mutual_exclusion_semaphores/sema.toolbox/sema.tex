...
\@x{}\moduleLeftDash\@xx{ {\MODULE} sema}\moduleRightDash\@xx{}%
\@pvspace{16.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{sema} - available initially
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
for process 1 and 2
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{1 \.{:}\@s{12.5}\.{\slsl} Non\.{-}critical} \ensuremath{section
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{2 \.{:}\@s{12.5}Request(sema)
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{3 \.{:}\@s{12.5}\.{\slsl} Critical} \ensuremath{section
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{4 \.{:}\@s{12.5}Release(sema)
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{5 \.{:} \}
...
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{Request(sema)\{
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{10.0}{0}{}%
\ensuremath{while(True)\{
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{10.0}{0}{}%
\ensuremath{if(sema \.{\defeq} available)\{
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{10.0}{0}{}%
\ensuremath{sema \.{=} busy;
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{break;
...
\vshade{5.0}%
\begin{cpar}{1}{F}{F}{0}{0}{}%
 \ensuremath{\.{\slsl} if} \ensuremath{statement} \ensuremath{till}
 \ensuremath{break} \ensuremath{is} \ensuremath{atomic
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{Release(sema)\{
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{10.0}{0}{}%
\ensuremath{sema \.{=} available
}%
\end{cpar}%
\begin{cpar}{1}{F}{F}{0}{0}{}%
\ensuremath{\}
...
\end{lcom}%
\@x{ {\EXTENDS} Integers}%
\@x{ {\VARIABLES} s0 ,\, s1 ,\, sema}%
\@pvspace{8.0pt}%
\@x{ Init0 \.{\defeq}}%
\@x{ \.{\land} sema \.{=}\@w{available}}%
\@x{ \.{\land} s0 \.{=} 0}%
\@pvspace{8.0pt}%
\@x{ Init1 \.{\defeq}}%
\@x{ \.{\land} sema \.{=}\@w{available}}%
...
\@x{ \.{\lor} Q50}%
\@pvspace{8.0pt}%
\@x{ SLOGP\@s{0.79} \.{\defeq} {\UNCHANGED} s0}%
\@x{ SLOGQ \.{\defeq} {\UNCHANGED} s1}%
\@pvspace{8.0pt}%
 \@x{ Next \.{\defeq} ( Next0 \.{\land} {\UNCHANGED} s1 ) \.{\lor} ( Next1
 \.{\land} {\UNCHANGED} s0 ) \.{\lor} SLOGP \.{\lor} SLOGQ}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@x{}%
\@y{\@s{0}%
 The terminology in the video is, Weak Fairness (in TLA+ world, not exactly
 Justice Conditions)
}%
\@xx{}%
\@pvspace{8.0pt}%
...
\@x{ \.{\land} {\lnot} ( s1 \.{=} 4 )}%
\@x{ \.{\land} {\lnot} ( s1 \.{=} 5 )}%
\@x{ \.{\land} {\lnot} ( s0 \.{=} 2 \.{\land} sema \.{=}\@w{available} )}%
\@x{ \.{\land} {\lnot} ( s1 \.{=} 2 \.{\land} sema \.{=}\@w{available} )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 but the problem with this is bounded weight need not be satisfied only with
 the first 10 justice conditions
}%
\@xx{}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{16.0pt}%
\@x{ P0\@s{0.79} \.{\defeq} s0 \.{=} 2 \.{\land} sema \.{=}\@w{available}}%
\@x{ Q0 \.{\defeq} s0 \.{\neq} 2}%
\@pvspace{8.0pt}%
\@x{ P1\@s{0.79} \.{\defeq} s1 \.{=} 2 \.{\land} sema \.{=}\@w{available}}%
\@x{ Q1 \.{\defeq} s1 \.{\neq} 2}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@x{}%
\@y{\@s{0}%
 \ensuremath{i.e} if \ensuremath{P0} wants to enter critical section (
 \ensuremath{i.e} it performs \ensuremath{request(sema)}, then
}%
\@xx{}%
\@x{}%
\@y{\@s{0}%
 eventually, \ensuremath{P0} will be allowed in critical section
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 Similarly for \ensuremath{P1
}}%
\@xx{}%
\@pvspace{144.0pt}%
\@x{}\bottombar\@xx{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Feb} 05 11:40:10 \ensuremath{IST} 2024 by
 \ensuremath{neerajkrishnan
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Feb} 02
 11:35:21 \ensuremath{IST} 2024 by \ensuremath{neerajkrishnan
}%
\end{cpar}%
\end{lcom}%
\end{document}
